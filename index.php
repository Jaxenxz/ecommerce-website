...
<body class="bg-gray-100 font-sans">
        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center">
                    <span class="text-2xl ml-2 font-semibold">Shopee</span>
                </div>
                <!-- เมนู Navbar ทางขวา -->
                <div class="flex items-center">
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- ข้อความคำยินดีต้อนรับ -->
        <div class="text-center mb-20 mt-20">
            <h1 class="text-5xl font-semibold">ยินดีต้อนรับสู่ Shopee Thailand</h1>
            <p class="text-2xl mt-2">เราพร้อมให้บริการคุณทุกครั้งที่คุณต้องการ</p>
        </div>

        <!-- สินค้ายอดนิยม -->
        <h1 class="text-3xl font-semibold mb-4 border-b-2 border-gray-300 pb-2">สินค้ายอดนิยม</h1>
        <!-- เลือกรายการสินค้ายอดนิยม -->
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mb-20">
            <?php
            // เชื่อมต่อกับฐานข้อมูล
            include 'config/db-config.php';

            // ดึงข้อมูลสินค้า
            $sql = "SELECT id, name, description, price, image_url FROM popular_products";
